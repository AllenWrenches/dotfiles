...
sudo scutil --set ComputerName "001707-MacBookPro"
sudo scutil --set HostName "001707-MacBookPro"
sudo scutil --set LocalHostName "001707-MacBookPro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "001707-MacBookPro"
